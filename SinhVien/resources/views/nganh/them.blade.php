    ...
    <div class="container">
        <div class="panel-group">
            <div class="panel panel-success">
                ...
                @endif
                <h1 class="panel-heading">Thêm mới ngành</h1>
                        ...
                        <div class="col-sm-4">
                            <form method="POST" action="{{ route('nganh.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Nhập ngành"
                                           required>
                                </div>
                                <button type="submit" class="btn btn-primary">Lưu lại</button>
                                <button type="reset" class="btn btn-info">Làm mới</button>
                                <a class="btn btn-danger" href="{{ route('nganh.index') }}">quay lai</a>
                            </form>
                        </div>
                    </div>
                </div>
